...
final class CropOverrides
{
	...
	static Crop selected(FarmingPatchAdvisorConfig config, PatchType type)
	{
		...
		switch (type)
		{
			...
			case ANIMA: choice = config.animaOverride(); break;
	...
	public enum Anima implements Choice { AUTOMATIC(null), ATTAS("Attas seed"), IASOR("Iasor seed"), KRONOS("Kronos seed"); private final String n; Anima(String n){this.n=n;} public String cropName(){return n;} public String toString(){return n == null ? "Automatic" : n;} }
